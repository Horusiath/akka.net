...
namespace Akka.DistributedData
{
    ...
    public interface IDeltaReplicatedData<T, TDelta> : IDeltaReplicatedData, IReplicatedData<T> where T : IReplicatedData
    {
        /// <summary>
    ...
    /// </summary>
    public interface IRequireCauseDeliveryOfDeltas : IReplicatedDelta { }
